...
test.describe('railroad diagrams', () => {
  test.describe('IR syntax (railroad-diagram)', () => {
...
digit = choice(terminal("0"), terminal("1"), terminal("2"), terminal("3")) ;
  ...
  test.describe('EBNF syntax (railroad-ebnf)', () => {
    test('renders sequences and choices', async ({ page }, testInfo) => {
      await imgSnapshotTest(
        page,
        testInfo,
...
digit = "0" | "1" | "2" ;
  ...
  test.describe('ABNF syntax (railroad-abnf)', () => {
...
digit = "0" / "1" / "2" / "3" ;
  ...
  test.describe('PEG syntax (railroad-peg)', () => {
